      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildTextField(AppStrings.fullName, _nameController,
                Icons.person_outline_rounded),
            const SizedBox(height: 20),
            _buildTextField(
                AppStrings.email, _emailController, Icons.email_outlined,
                enabled: false),
            const SizedBox(height: 20),
            _buildTextField(AppStrings.phone, _phoneController,
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: AppColors.primaryBlue.withOpacity(0.1), width: 4),
            ),
